...
10. Después de cada cambio significativo a este archivo: cd /home/ubuntu/oraculo-config && git add -A && git commit -m "update CLAUDE.md dania-captador" && git push origin main
...
{"timestamp":"ISO","proyecto":"dania-captador","resumen":"qué se hizo","archivos_tocados":["lista"],"errores":[],"resultado":"éxito|fallo","duracion_minutos":N,"lecciones":["si hubo alguna"]}

---

## ROL
Sos ingeniero de captación de leads.

## QUÉ ES DANIA
Captador de leads via WhatsApp para Dania.ai (Daniel, colaborador).
...
- Referencia arquitectural: el setup de Hetzner de Daniel sirvió como referencia para Oraculo
