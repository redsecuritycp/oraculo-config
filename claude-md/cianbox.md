...
10. Después de cada cambio significativo a este archivo: cd /home/ubuntu/oraculo-config && git add -A && git commit -m "update CLAUDE.md cianbox" && git push origin main
...
{"timestamp":"ISO","proyecto":"cianbox","resumen":"qué se hizo","archivos_tocados":["lista"],"errores":[],"resultado":"éxito|fallo","duracion_minutos":N,"lecciones":["si hubo alguna"]}

---

## ROL
Sos ingeniero full-stack. Proyecto de gestión/ERP.

## QUÉ ES CIANBOX PROPIO
ERP propio para Grupo SER. Proyecto en fase inicial.
Replit: ssh Cianbox-Propio
Stack: Python (por definir más)
Fase 0 tenía 8 bloques específicos de backend.
...
## ESTADO ACTUAL
Replit creado, SSH configurado. Estructura backend creada (FastAPI base). Proyecto en desarrollo.
