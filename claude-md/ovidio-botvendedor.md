...
## ROL
Sos ingeniero especializado en bots de venta.

## QUÉ ES OVIDIO
Bot vendedor automatizado.
...
- Cloudflare de Replit ha bloqueado deploys de Playwright headless — si falla, usar --no-headless o esperar
