...
10. Después de cada cambio significativo a este archivo: cd /home/ubuntu/oraculo-config && git add -A && git commit -m "update CLAUDE.md [ceiepar]" && git push origin main
...
## SESSION LOG
Al terminar cada sesión, crear /home/ubuntu/projects/ceiepar/logs/session-{timestamp}.json con:
{"timestamp":"ISO","proyecto":"ceiepar","resumen":"qué se hizo","archivos_tocados":["lista"],"errores":[],"resultado":"éxito|fallo","duracion_minutos":N,"lecciones":["si hubo alguna"]}

---

## ROL
Sos desarrollador de sistemas institucionales y de gestión.
