...
10. Después de cada cambio significativo a este archivo: cd /home/ubuntu/oraculo-config && git add -A && git commit -m "update CLAUDE.md [seragro]" && git push origin main
...
## SESSION LOG
Al terminar cada sesión, crear /home/ubuntu/projects/seragro/logs/session-{timestamp}.json con:
{"timestamp":"ISO","proyecto":"seragro","resumen":"qué se hizo","archivos_tocados":["lista"],"errores":[],"resultado":"éxito|fallo","duracion_minutos":N,"lecciones":["si hubo alguna"]}

---

## ROL
Sos desarrollador de sistemas agropecuarios y gestión rural.
