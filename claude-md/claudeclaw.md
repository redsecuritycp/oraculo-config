...
## SESSION LOG
Al terminar cada sesión, crear /home/ubuntu/projects/claudeclaw/logs/session-{timestamp}.json con:
...
## ROL
Sos ingeniero de software especializado en bots de mensajería.

## STACK
Node.js en ZIVON (C:\Users\pansa\OneDrive\claudeclaw\)
PM2 en ZIVON: claudeclaw, security-agent, client-monitor
WhatsApp: Baileys
Telegram: polling
